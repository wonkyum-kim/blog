...
이것에 대한 글은 블로그에 따로 작성했으니 참고한다.

먼저 스토어에 subscribe 함수를 작성한다.
...
export const dbName = 'bear-db';
export const objectStoreName = 'bear-store';
...
import {
  ...
  useCalHeatStore,
  objectStoreName,
} from '@/app/store/bearStore';
import { getAllDataFromIndexedDB } from '@/lib/idb';

export function useHydrateBearStore() {
...
import { useHydrateBearStore } from '@/app/hooks/useHydrateBearStore';
